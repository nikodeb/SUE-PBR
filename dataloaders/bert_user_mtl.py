...
class BertUserMtlDataloader(AbstractDataloader):
    def __init__(self, args, dataset):
        """
        This is the data loader class for the personalised bidirectional model.
        We also share it for SSE + MTL experiments.
    ...
    def _get_eval_dataset(self, mode):
        ...
        if mode == 'test':
            dataset = BertUserEvalDataset(self.train, answers, self.max_len, self.CLOZE_MASK_TOKEN,
...
class BertUserMtlTrainDataset(data_utils.Dataset):
    ...
    def __getitem__(self, index):
        ...
        # Here we perform SSE-SE embedding switching
        # proportion_of_orig_user used as MTL target
...
class BertUserEvalDataset(data_utils.Dataset):
